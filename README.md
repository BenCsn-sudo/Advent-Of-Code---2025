...
Bienvenue sur mon dépôt de solutions pour l'**Advent of Code 2025** \! 🎅

C'est ici que je documente mon voyage à travers les 25 jours de puzzles de programmation, en essayant de sauver Noël (encore une fois) grâce au code. L'objectif est de collecter les 50 étoiles ⭐️ dorées avant le 25 décembre.

## 📂 Structure du Projet

Le dépôt est organisé de manière modulaire. Chaque jour possède son propre dossier contenant tout le nécessaire pour comprendre et exécuter la solution.
...
Voici l'état d'avancement de ma récolte d'étoiles.
...
Pour lancer une solution spécifique, naviguez dans le dossier du jour correspondant et exécutez le script.
...
L'[Advent of Code](https://adventofcode.com/) est un calendrier de l'Avent composé de petits puzzles de programmation pour tous les niveaux, qui peuvent être résolus dans n'importe quel langage de programmation.
